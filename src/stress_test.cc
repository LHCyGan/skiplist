...
int main() {
  skipList.Insert(Key(1, "a")); 
  skipList.Insert(Key(3, "b")); 
  skipList.Insert(Key(2, "3")); 
  skipList.Insert(Key(6, "h")); 
  skipList.Insert(Key(4, "f")); 

  skipList.Display();

  skipList.DumpFile("/home/dell/CODE/skiplist/dumpfile");
